// dear imgui, v1.89.6
// (widgets code)
// ****  Most of this source code is brought from imgui. **** 
...
bool ImGui::InputTextCodeEditor(const char* label, char* buf, int buf_size, const ImVec2& size_arg, ImGuiInputTextFlags flags , ImGuiInputTextCallback callback, void* callback_user_data)
{
